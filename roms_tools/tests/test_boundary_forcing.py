...
def test_boundary_forcing_data_consistency_plot_save(
    ...
    expected_u_east = np.array(
        [
            [
                [-0.0, -0.0, 0.06334759, 0.03555659],
                [-0.0, -0.0, 0.0236859, 0.03713445],
                [-0.0, -0.0, -0.02354126, 0.02392998],
            ]
        ],
        dtype=np.float32,
    )
    ...
    expected_u_west = np.array(
        [
            [
                [-0.0, -0.0, 0.0, 0.04009043],
                [-0.0, -0.0, -0.0, 0.0349412],
                [-0.0, -0.0, -0.0, 0.03305725],
            ]
        ],
        dtype=np.float32,
    )
    ...
    expected_v_north = np.array(
        [
            [
                [-0.00779556, -0.0, 0.0237356, -0.08123003],
                [-0.00770537, -0.0, 0.03198036, -0.08685598],
                [-0.02848312, -0.0, 0.00935264, -0.15538278],
            ]
        ],
        dtype=np.float32,
    )
    ...
    expected_ubar_east = np.array(
        [[0.0, 0.0, 0.02369577, 0.03251844]], dtype=np.float32
    )
    expected_ubar_north = np.array(
        [[0.036187, 0.04258458, 0.03251844]], dtype=np.float32
    )
    expected_ubar_west = np.array([[0.0, 0.0, 0.0, 0.036187]], dtype=np.float32)

    expected_vbar_south = np.array([[0.0, 0.0, 0.0, 0.0]], dtype=np.float32)
    expected_vbar_east = np.array([[0.0, 0.0, -0.10577434]], dtype=np.float32)
    expected_vbar_north = np.array(
        [[-0.01424322, 0.0, 0.02204982, -0.10577434]], dtype=np.float32
    )
    expected_vbar_west = np.array([[0.0, 0.0, -0.01424322]], dtype=np.float32)
