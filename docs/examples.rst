...
The following examples cover task-specific workflows for the Perlmutter and Anvil supercomputers. Pre-download data and adjust paths as needed. For a full end-to-end workflow designed to run on a laptop, refer to the section above.
