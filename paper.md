---
title: 'ROMS-Tools: Reproducible, Scalable Preprocessing and Analysis for Regional Ocean Modeling with ROMS'
tags:
  - Python
  - ocean modeling
  - ROMS
...
`ROMS-Tools` is designed to balance **ease of use, flexibility, reproducibility, and scalability** by combining high-level user interfaces with a modular, extensible architecture. A key goal is to reduce barriers for new users, addressing recurring pain points observed in the legacy MATLAB preprocessing scripts developed at UCLA.
