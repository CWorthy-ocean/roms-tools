...
The horizontal grid is generated by creating an instance of the <inv:#*.Grid> class. For practical examples, see [this notebook](grid.ipynb).
...
The tidal forcing data is sourced from the TPXO atlas, which is based on {cite}`egbert_efficient_2002`. The TPXO data undergoes two essential corrections:
