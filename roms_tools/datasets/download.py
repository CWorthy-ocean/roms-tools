...
pup_test_data = pooch.create(
    # Use the default cache folder for the operating system
    path=pooch.os_cache("roms-tools"),
    base_url="https://github.com/CWorthy-ocean/roms-tools-test-data/raw/soda_data_add/",
    # The registry specifies the files that can be fetched
    registry={
        ...
        "coarsened_OceanSODA_dataset.nc": "sha256:9a447c079bb2db37c680fdea1825134d10091dfca362a65e2d7b9c71833b09d7",
