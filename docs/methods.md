...
The tidal forcing data is sourced from the TPXO atlas, which is based on :cite:t:`egbert_efficient_2002`. The TPXO data undergoes two essential corrections:
