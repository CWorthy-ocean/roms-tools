...
class TestNesting:
    ...
    def test_error_if_child_boundary_entirely_on_land(self):
        parent_grid = Grid(
            nx=7,
            ny=7,
            size_x=240,
        ...
        with pytest.raises(
            ValueError,
            match="The entire southern boundary of the child grid lies on land.",
        ):
            ChildGrid(
                **child_grid_parameters,
        ...
        with pytest.raises(
            ValueError,
            match="The entire eastern boundary of the child grid lies on land.",
        ):
            ChildGrid(
                **child_grid_parameters,
                parent_grid=parent_grid,
